...
@Component({
  selector: 'app-faculty-leave-status',
  templateUrl: './faculty-leave-status.component.html',
  styleUrls: ['./faculty-leave-status.component.css']
})
export class FacultyLeaveStatusComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.LoginService.readFacultyLeave(this.id).subscribe((leaves: leaveStatus[])=>{
      this.leaves = leaves;
